...
class Page{
     ...
     */
    public function __construct($totalRows, $listRows=20, $parameter = array(), $url='', $target='', $pagesId='') {
        ...
        // 保证nowPage的之合理
        $this->nowPage    = min($this->nowPage ,  $this->totalPages);	// $this->totalPage可能小于0
        $this->nowPage    = max($this->nowPage , 1) ;
