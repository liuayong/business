...
<link type="text/CSS" rel="stylesheet" href="../../../ThinkPHP/Library/Vendor/barcodegen/html/style.css" />
...
?>
<form action="" name="barcode_drawer" method="post">
<?php
...
if(!empty($text2display)) {
	...
	$table->setText(10, 0, '<img src="image?code=' . $filename . '&amp;o=' . $output . '&amp;dpi=' . $dpi . '&amp;t=' . $thickness . '&amp;r=' . $res . '&amp;rot=' . $rotation . '&amp;text=' . urlencode($text2display) . '&amp;f1=' . $font_family . '&amp;f2=' . $font_size . '&amp;a1=' . $a1 . '&amp;a2=' . $a2 . '&amp;a3=' . $a3 . '" alt="Barcode Image" />');
}
?>