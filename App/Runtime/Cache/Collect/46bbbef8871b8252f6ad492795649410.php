...
<html>
    <head>
        ...
        <link href="/business/App/Collect/View/Public/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen" />
        <link href="/business/App/Collect/View/Public/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen"  />
        <script src="/business/App/Collect/View/Public/jquery/jquery-1.10.2.min.js"></script>
        <script src="/business/App/Collect/View/Public/bootstrap/js/bootstrap.min.js"></script>
        <link href="/business/App/Collect/View/Public/css/layout.css" rel="stylesheet" media="screen">
    </head>
    <body>
        <!--公共页头-->
    ...
    <h4>你好，欢迎使用采集系统</h4>
    <div class="btn-group">
        <a href="javascript:;" class="btn btn-primary btn-mini">前台</a>
        <a href="javascript:;" class="btn btn-primary btn-mini">地图</a>
        <a href="javascript:;" class="btn btn-primary btn-mini">退出</a>
    </div>
</div>
...
<table class="table table-striped table-hover">
    ...
    <?php if(is_array($volist)): $i = 0; $__LIST__ = $volist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["web_site"]); ?></td>
            <td><?php echo ($vo["web_name"]); ?></td>
            <td><span class="label label-success"><?php if($vo['is_down']==1): ?>下载<?php else: ?>不下载<?php endif; ?></span></td>
            <td><span class="label label-warning"><?php echo ((isset($vo["charset"]) && ($vo["charset"] !== ""))?($vo["charset"]):"自动"); ?></span></td>
            <td><?php echo date("Y-m-d",$vo['create_time']);?></td>
            <td><?php echo date("Y-m-d H:i",$vo['update_time']);?></td>
            <td>
                <div class="btn-group">
                    <a href="<?php echo U('Index/edit',array('id' =>$vo['id']));?>" class="btn btn-primary btn-small">编辑</a>
                    <a href="javascript:;" class="btn btn-warning btn-small">删除</a>
                </div>
            </td>
            <td>
                <div class="btn-group">
