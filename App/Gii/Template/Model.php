namespace <?php echo $moduleName; ?>\<?php echo $modLayer; ?>;
<?php echo $useExpression ; ?> 

/**
 * <?php echo $this->tableComment; ?>模型
 */
class <?php echo $tpName.$modLayer; ?> extends <?php echo $superModelName ; ?>  {
    
    
     protected $_validate = [
        <?php
	echo "// array(field,rule,message,condition,type,when,params) \n ";
	echo "\t// array(field, url,'错误提示',self::VALUE_VALIDATE, callback, self:MODEL_BOTH , params) \n ";
	echo $str ."\n";
        ?>
    ];
