...
class NavController extends CommonController {
	...
	#$CateModel = new \MangerSystem\Model\NavCateModel('blog','think_');
	#$CateModel = new \MangerSystem\Model\NavCateModel('blog','think_', 'mysql://root:123123@localhost/note_book');
	$this->display();
    }
